...
La simmetria del problema suggerisce di usare delle coordinate cilindriche $(r,\varphi,z)$, dove $r = \sqrt{x^2 + z^2}$ \`e il raggio del filo misurato dal suo centro.
\begin{wrapfigure}{r}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.4\textwidth]{images/cable}  % Include your image here
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/adjointfield} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/spirenew} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/torus} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/doublewire} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/centripede} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/spiral} % Adjust width as necessary
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left, width for the figure box
    \centering
    \includegraphics[width=0.38\textwidth]{images/cyclovector} % Adjust width as necessary
\end{wrapfigure}
...
\vspace{-1cm}
    \centering
    \includegraphics[width=0.38\textwidth]{images/squarespire} % Adjust width as necessary
\end{wrapfigure}
...
Quando una corrente circola in un conduttore in presenza di un campo magnetico, le cariche libere in moto risentono della forza di Lorentz, sperimentalmente quello che si osserva \`e l'azione della forza sul conduttore nel suo insieme.

\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.4\textwidth]{images/hall1}  % Include your image here
\end{wrapfigure}
 In una barra metallica percorsa da una corrente stazionaria, gli elettroni guidati dal campo elettrico $\bold{E}$, si muovo con verso concorde lungo l'asse $\hat{u}_{y}$ con velocit\`a media $\langle \bold{v} \rangle $. Il reticolo cristallino del metallo costituito da ioni costituisce la struttura d'interazione tra le cariche e il metallo.
  ...
  \vspace{-1.6cm}
    \centering
    \includegraphics[width=0.4\textwidth]{images/hall2}  % Include your image here
\end{wrapfigure}
La densit\`a di corrente $\bold{J} = nq \langle v \rangle $ si lega al campo elettrico mediante il coefficiente di conducibilit\`a del metallo 
 ...
 Ipotizziamo ora di applicare al sistema un campo magnetico $\bold{B} = B\hat{u}_{x}$ che risulta essere ortogonale alla velocit\`a media delle cariche; tale interazione prodice una deviazione verso il basso degli elettroni in moto. 
 \newpage 
\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.4\textwidth]{images/hall3}  % Include your image here
\end{wrapfigure}
...
\end{equation*}
 ...
 Quantitativamente il campo $E_t$ \`e dato dall'uguaglianza 
 \begin{equation*}
...
\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.26\textwidth]{images/pressionemagneto}  % Include your image here
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.26\textwidth]{images/pressionemagneto1}  % Include your image here
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.26\textwidth]{images/magnenrgy}  % Include your image here
\end{wrapfigure}
...
La pressione compie un lavoro apparente dato da 
\begin{equation*}
...
\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.37\textwidth]{images/magnergy1}  % Include your image here
\end{wrapfigure}
...
\subsection{Esempio 1: Lavoro apparente della forza magnetica}
\begin{wrapfigure}{l}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.4\textwidth]{images/batteriaplane}  % Include your image here
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}  % r for right alignment, 0.4 is the width of the figure
    \centering
    \includegraphics[width=0.4\textwidth]{images/batteriaplane1}  % Include your image here
\end{wrapfigure}
...
$\bold{F}_{B}$ ha una componente lungo x, in verso opposto alla corrente, di conseguenza la batteria compie lavoro contro $F_x$ per mantenere la corrente stazionarie e quindi compiendo un lavoro
\begin{equation*}
