...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/mutual_inductance} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/bobine} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/autoinductance} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \vspace{-0.7cm}
    \centering
    \includegraphics[width=0.35\textwidth]{images/toroid} % Replace with your image
\end{wrapfigure}
Data una bobina toroidale di altezza $h$ con raggio interno $a$, raggio esterno $b$ dotata di N avvolgimenti, calcolare la sua autoinduttanza.
	...
	\vspace{-1.2cm}
    \centering
    \includegraphics[width=0.34\textwidth]{images/integration_path} % Replace with your image
\end{wrapfigure}
...
%IMMAGINE QUI PAGINA 10 SETTIMANA 10%
	\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/RL_circuit} % Replace with your image
\end{wrapfigure}
...
%IMMAGINE PAGINA 12 SETTIMANA 10 %
	\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/inductance_discharge} % Replace with your image
\end{wrapfigure}
...
\subsubsection{Induttori in Serie}
	\begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.25\textwidth]{images/inductance_series} % Replace with your image
\end{wrapfigure}
...
%IMMAGINE QUI%
	\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.38\textwidth]{images/inductance_parallel} % Replace with your image
\end{wrapfigure}
...
%IMMAGINE QUI PAGINA 14 SETTIMANA 10%
	...
	\vspace{-0.5cm}
    \centering
    \includegraphics[width=0.34\textwidth]{images/transformator} % Replace with your image
\end{wrapfigure}
...
%IMMAGINE PAGINA 18 SETTIMANA 10%
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.34\textwidth]{images/toroid1} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.37\textwidth]{images/mutual_inductance1} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.38\textwidth]{images/superconducting_plane} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.32\textwidth]{images/RLC} % Replace with your image
\end{wrapfigure}
...
Nel caso sottosmorzato le soluzioni dell'equazione caratteristica sono numeri complessi
\begin{equation*}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.32\textwidth]{images/RLC_alternate} % Replace with your image
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} % 'r' for right, 'l' for left
    \centering
    \includegraphics[width=0.39\textwidth]{images/coaxsial_cable} % Replace with your image
\end{wrapfigure}
